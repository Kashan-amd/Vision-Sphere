...
class ProductController extends Controller
{
    ...
    public function StoreProduct(Request $request)
    {
        ...
        $thumbnailPath = public_path('upload/products/thambnail');
        $multiImagePath = public_path('upload/products/multi-image');
        ...
        if (!File::exists($multiImagePath)) {
            File::makeDirectory($multiImagePath, 0755, true);
        }
        ...
        $product_id = Product::insertGetId([
            ...
            'product_shape' => $request->product_shape,
        ...
        foreach ($images as $img) {
            ...
            Image::make($img)->resize(800, 800)->save($multiImagePath . '/' . $make_name);
    ...
    public function updateProduct(Request $request, $product_id)
    {
        ...
        if ($request->hasFile('product_thambnail')) {
            ...
            Image::make($image)->save(public_path($save_url));
        }
