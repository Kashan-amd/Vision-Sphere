    ...
    <div class="row flex-row-reverse">
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div class="sidebar-widget widget-category-2 mb-30">
                <h5 class="section-title style-1 mb-30">Shapes</h5>
                <ul>
                    @foreach ($shapesWithCounts as $shapeData)
                        <li>
                            <a href="{{ route('products.by.shape', ['shape' => $shapeData->product_shape]) }}">
                                {{ $shapeData->product_shape }} ({{ $shapeData->products_count }})
                            </a>
                        </li>
                    @endforeach
                </ul>
