    ...
    <div class="row flex-row-reverse">
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div class="sidebar-widget widget-category-2 mb-30">
                <h5 class="section-title style-1 mb-30">Materials</h5>
                <ul>
                    @foreach ($materialsWithCounts as $materialData)
                        <li>
                            <a href="{{ route('products.by.material', ['material' => $materialData->product_material]) }}">
                                {{ $materialData->product_material }} ({{ $materialData->products_count }})
                            </a>
                        </li>
                    @endforeach
                </ul>
