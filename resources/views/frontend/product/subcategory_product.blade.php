                    ...
                    <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                        <div class="product-img-action-wrap">
                            ...
                            <div class="product-action-1">
                                <a aria-label="Add To Wishlist" class="action-btn" href="{{ route('wishlist.add', $product->id) }}"><i class="fi-rs-heart"></i></a><a aria-label="Add To Wishlist" class="action-btn" href="#"><i class="fi-rs-heart"></i></a>
        ...
        <div class="sidebar-widget widget-category-2 mb-30">
            ...
            <div class="banner-img wow fadeIn mb-lg-0 animated d-lg-block d-none">
                ...
                <div class="banner-text">
                    <span>Awsome Place..</span>
                    <h4>
                        Go little <br />
                        <span class="text-brand">Rock Star</span><br />
                        ...
                    </h4>
                </div>
            </div>
