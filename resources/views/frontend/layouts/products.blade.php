                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ url('/product-details/'.$product->id.'/'.$product->product_slug) }}">
                                            <img height="auto" class="default-img" src="{{ asset($product->product_thambnail) }}" alt=""/>
                                            @if ($product->multiImages->count() > 1)
                                                <img height="auto" class="hover-img" src="{{ asset($product->multiImages->skip(1)->first()->photo_name) }}" alt="" />
                                            @endif
                                        </a>
                                    </div>
            ...
            <div class="col-lg-3 d-none d-lg-flex wow animate__animated animate__fadeIn">
                <div class="banner-img style-2">
                    <div class="banner-text">
                        <h2 class="mb-100">Find it here Try it now!</h2>
                    </div>
                </div>
            </div>
                                ...
                                @foreach ($productsdata as $product)
                                    <div class="product-cart-wrap">
                                        ...
                                        <form method="POST" action="{{ route('cart.add') }}" class="add-to-cart-form">
                                            ...
                                            <input type="hidden" name="price" value="{{ $product->selling_price }}">
                                            <input type="hidden" name="quantity" value="1" min="1" required>
                                            <button style="width:100%" class="button button-add-to-cart"><i class="fi-rs-shopping-cart mr-5"></i></button>
                                        </form>
                                    </div>
                                @endforeach
                            </div>
