    ...
    <footer class="main">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="position-relative newsletter-inner-1">
                            <div class="newsletter-content">
                                <h3 style="background:white; border-radius:20px; padding:30px 30px">
        ...
        <section class="featured-footer section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            <div class="logo mb-30">
                                <a href="{{ '/' }}" class="mb-15"><img height="50rem" src="{{ asset('frontend/assets/imgs/theme/logo-alt-1-white.png') }}" alt="logo" /></a>
                                <p class="font-lg text-heading text-white">something here.. like 3 to 4 lines, like something really interesting or like a really long slogan but have to add something real here...</p>
                            </div>
                           
                        </div>
                    </div>
                    <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        <ul class="contact-infor text-white">
                            <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-location.svg') }}" alt="" /><strong>Address: </strong> <span>somewhere, abc</span></li>
                            <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg') }}" alt="" /><strong>Call Us:</strong><span>090078601</span></li>
                            <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-email-2.svg') }}" alt="" /><strong>Email:</strong><span>visionsphere@support.com</span></li>
                        </ul>
                    </div>
