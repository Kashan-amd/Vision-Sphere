...
<div class="container" style="min-height: 80vh; padding: 2rem 1rem;">
    <div class="terms-content" style="margin: 0 20px;"> <!-- Adjusted margins -->
        
        <h1 style="font-size: 3rem; font-weight: 800; text-align: center; margin: 3rem 0 1rem 0;">
            Terms & Conditions
        </h1>
        
        <h2 style="font-size: 1.25rem; font-weight: 600; text-align: left; margin-top: 1.5rem;">1. Acceptance of Terms</h2>
        ...
        <h2 style="font-size: 1.25rem; font-weight: 600; text-align: left; margin-top: 1.5rem;">2. Eligibility</h2>
        <p style="text-align: left;">
        ...
        <h2 style="font-size: 1.25rem; font-weight: 600; text-align: left; margin-top: 1.5rem;">3. Account Registration</h2>
        <p style="text-align: left;">
        ...
        <h2 style="font-size: 1.25rem; font-weight: 600; text-align: left; margin-top: 1.5rem;">4. Use of Services</h2>
        <p style="text-align: left;">
        ...
        <h2 style="font-size: 1.25rem; font-weight: 600; text-align: left; margin-top: 1.5rem;">5. Intellectual Property</h2>
        <p style="text-align: left;">
        ...
        <h2 style="font-size: 1.25rem; font-weight: 600; text-align: left; margin-top: 1.5rem;">6. Limitation of Liability</h2>
        <p style="text-align: left;">
        ...
        <h2 style="font-size: 1.25rem; font-weight: 600; text-align: left; margin-top: 1.5rem;">7. Termination</h2>
        <p style="text-align: left;">
        ...
        <h2 style="font-size: 1.25rem; font-weight: 600; text-align: left; margin-top: 1.5rem;">8. Governing Law</h2>
        <p style="text-align: left;">
        ...
        <h2 style="font-size: 1.25rem; font-weight: 600; text-align: left; margin-top: 1.5rem;">9. Changes to These Terms</h2>
        <p style="text-align: left;">
