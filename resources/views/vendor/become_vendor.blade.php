                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            ...
                                            <p class="mb-30">Already have an Vendor account? <a href="{{ route('login') }}">Vendor Login</a></p>
                                        </div>
                                        ...
                                        @csrf
                                            ...
                                            <div class="form-group">
                                                <select name="vendor_join_year" class="form-select mb-3" aria-label="Default select example" required>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                <div class="text-center">
                    <img src="{{ asset('frontend/assets/imgs/theme/loading-alt.gif') }}" alt="" />
                </div>
            </div>
        </div>
    </div>
